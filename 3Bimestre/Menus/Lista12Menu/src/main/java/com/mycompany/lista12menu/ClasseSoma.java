...
import java.awt.event.*;
  ...
  public class ClasseSoma extends JDialog
   {
     JButton sair , limpar;
     ...
     public ClasseSoma(Frame owner, String title, boolean modal)
     {
      ...
      somar2n.setBounds(50,100,80,20);
