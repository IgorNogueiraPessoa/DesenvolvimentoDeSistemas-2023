...
import java.awt.event.*;
  ...
  public class ClasseMulti extends JDialog
   {
     JButton sair , limpar;
     JLabel rotulo1, rotulo2, rotulo3, exibir;
     JTextField texto1, texto2;
     JButton multiplicar2n;
     
     public ClasseMulti(Frame owner, String title, boolean modal)
     {
      ...
      multiplicar2n.setBounds(50,100,100,20);
      limpar.setBounds(160,250,100,20);
      
      
      
      //funcionalidade do botão multiplicar
      multiplicar2n.addActionListener(
      new ActionListener(){
